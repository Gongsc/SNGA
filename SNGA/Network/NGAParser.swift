...
struct NGAParser: Sendable {
    ...
    func sanitizedPostHTML(_ source: String) -> String {
        ...
        <style>
        :root{color-scheme:light dark;--snga-accent:#b06d00;--snga-highlight:#d59b3a}html,body{width:100%;max-width:100%;overflow-x:hidden;overflow-y:hidden}body{font:14px -apple-system,BlinkMacSystemFont,sans-serif;margin:0;color:CanvasText;background:transparent;overflow-wrap:anywhere;line-height:1.55}
        #snga-post-content{display:flow-root;width:100%;max-width:100%;min-height:1px}
        img{max-width:100%;height:auto;vertical-align:middle}.nga-smile{max-width:64px;max-height:64px}table{max-width:100%;border-collapse:collapse;display:block;overflow:auto}td,th{border:1px solid color-mix(in srgb,CanvasText 20%,transparent);padding:4px}
