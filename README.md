...
- V2EX 目前接了浏览、回复、感谢、节点搜索、用户动态、节点收藏、话题收藏和每日登录奖励；提醒还没接（见 [Design/SiteProbe-V2EX.md](Design/SiteProbe-V2EX.md)）
- V2EX 自己没有主题全文搜索，应用里那一档接的是站点搜索框中的第三方 SoV2EX：关键词会发给 sov2ex.com，但不会带上登录状态；可按作者、发帖日期区间和排序方式筛选
- V2EX 没有站内私信，正文里的用户链接会交给浏览器打开（站点的用户地址里是用户名，换成编号要额外请求一次）
- 不提供离线全文归档和自动更新
